...
版本命名规范：dev分支（开发中/测试版）+main分支（正式版大版本/Release）：[年份]w[周数]a_[分支名]_[年份].[main分支提交次数].[小版本号]，通常main分支的小版本号为0，比如2026年第十三周，main分支提交次数110，那么main版本号为26w13a_main_26.110.0;比如2026年第十三周，main分支提交次数110，dev开发阶段Phase 9（通常为Phase 1-Phase 10，Phase 10完成时以dev的版本号提交到dev后以main的版本号合并到main）那么dev版本号为26w13a_dev_26.110.9，完成26w13a_dev_26.110.10后提交26w13a_main_26.111.0
