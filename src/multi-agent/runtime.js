 ...
 */
export function registerAgent(agent<Agent, "id" | "lastHeartbeat">) {
  const fullAgent = {
    ...agent,
    id("agent"),
    lastHeartbeat(),
 ...
 * @param agentId - Agent ID
 */
export function getAgent(agentId) | undefined {
 ...
 */
export function getAssignment(assignmentId) | undefined {
 ...
 * @param taskId - Task ID
 */
export function loadCheckpoint(taskId) | null {
  // Try memory first
