...
const activeExecutions = new Map<string, SandboxExecution>();

export async function executeSandboxed(
  code: string,
  config: SandboxConfig = createDefaultSandboxConfig(),
...
export function getActiveExecutions(): SandboxExecution[] {
