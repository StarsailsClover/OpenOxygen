 ...
 */
async;
findElementByVisual(description) < VisualElement | null > {
 ...
 */
async;
inputByVisual(description, text);
{
 ...
 */
async;
waitForElementVisual(description, timeoutMs = 5000);
{
 ...
 */
async;
getElementTextVisual(description) < string | null > {
    const: element = await this.findElementByVisual(description),
