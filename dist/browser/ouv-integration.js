...
export class OUVBrowserIntegration {
     ...
     */
    async findElementByVisual(description) {
     ...
     */
    async waitForElementVisual(description, timeoutMs = 5000) {
     ...
     * @param description - Visual description
     */
    async getElementTextVisual(description) {
        const element = await this.findElementByVisual(description);
...
//# sourceMappingURL=ouv-integration.js.map