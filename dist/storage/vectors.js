...
addChunk(chunk);
{
    ...
    this.sqliteStore.saveChunk({
        ...
        startLine, : .startLine,
        endLine, : .endLine,
        contentHash() { }, : .update(chunk.content).digest("hex").slice(0, 16),
...
{
    return {
        memoryChunks, : .memoryStore.getChunkCount(),
        dbChunks, : .sqliteStore.getChunkCount(),
        cacheSize, : .embeddingCache.size,
        maxMemory, : .maxMemoryChunks,
