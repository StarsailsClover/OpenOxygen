 ...
 */
export function registerGlobalHotkey(keyCombination, callback) {
 ...
 */
export function showSystemTrayInput() {
 ...
 */
export async function voiceInput(durationMs = 5000) {
 ...
 */
export function startClipboardListener(callback) {
