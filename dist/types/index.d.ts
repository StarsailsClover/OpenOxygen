 ...
 *
 * 全局基础类型，所有模块共享�? * 设计原则：与 OpenClaw 接口协议对齐但完全独立实现�? */
...
export type ModelProvider = "openai" | "anthropic" | "gemini" | "openrouter" | "ollama" | "stepfun" | "custom";
...
export type RouteMatch = "binding.peer" | "binding.channel" | "binding.account" | "default";
...
export type SystemOperation = "file.read" | "file.write" | "file.delete" | "file.list" | "process.start" | "process.kill" | "process.list" | "registry.read" | "registry.write" | "network.request" | "clipboard.read" | "clipboard.write" | "screen.capture" | "input.keyboard" | "input.mouse";
...
export type PluginHookPhase = "before-inference" | "after-inference" | "before-execution" | "after-execution" | "on-message" | "on-error";
