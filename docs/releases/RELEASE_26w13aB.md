...
## 🎯 Release Focus: User Experience & Deployment
...
## ✨ What's New in 26w13aB

### User Experience

- ✅ **One-click start**: `start.bat` for Windows
- ✅ **Auto-dependency check**: Detects missing Node.js/Rust
- ✅ **Auto-build**: Builds native modules on first run
- ✅ **Clear error messages**: Human-readable error guidance

### Documentation

- ✅ **INSTALL.md**: Step-by-step installation
- ✅ **QUICKSTART.md**: 5-minute getting started
- ✅ **Model configuration guide**: How to add local/remote models
...
- Enhanced training mode (10min × 10 rounds)
